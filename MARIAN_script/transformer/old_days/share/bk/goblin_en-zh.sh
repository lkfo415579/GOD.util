...
SRCL=en
TGTL=zh
CORPUS=train.Common.en-zh
CORPUS_DIR=/data/marian-examples/goblin/crazy
MODELS_DIR=GOBLIN_MODEL_COM
DEV_SET=valid.Common.en-zh
# set chosen gpus
if [ $# -ne 0 ]
then
    GPUS=$@
...
# train $MODELS_DIR
    $MARIAN/build/marian \
        ...
        --tied-embeddings-all \
        --devices $GPUS --sync-sgd --seed 3333
