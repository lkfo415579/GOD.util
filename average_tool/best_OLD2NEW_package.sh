...
TMP=($MODELS)
MODELS="model_revo.npz.best-translation.npz"
# for (( i = 0; i < $TOP; i++ )); do
#   MODELS="$MODELS ${TMP[$i]}"
# done
# MODELS=($MODELS)
...
echo "Converting NEW MODEL 2 OLD MODEL architecture"
python $P/../performance/convert/NM2OM.py model_revo_amun.avg.npz

mv tmp.npz model_revo_amun.avg.npz
